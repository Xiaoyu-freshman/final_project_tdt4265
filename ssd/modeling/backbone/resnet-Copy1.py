...
class ResNet(torch.nn.Module):
    ...
    #1.resnet18_pre-trained
        resnet18 = models.resnet18(pretrained=True)
        resnet = torch.nn.Sequential(*list(resnet18.children())[:-2])
        self.to_layer2 = resnet[0:6] #38*38
        self.layer3 = resnet[6] #19*19
        self.layer4 = resnet[7] #10*10
    ...
    def forward(self, x):
        ...
        for i, f in enumerate(self.extra_layer): #i means the index and f means the function of the layer
            ...
            if i % 2 == 1:
                out_features.append(x)
#             print('layer:',f)
#             print('out_features',out_features[-1].shape)
